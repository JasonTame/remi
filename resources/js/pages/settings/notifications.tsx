    ...
    return (
        <AppLayout title="Notification preferences">
            ...
            <SettingsLayout>
                <Card>
                    <CardHeader>
                        <HeadingSmall title="Notification preferences" description="Manage how and when Remi reminds you about tasks" />
                    </CardHeader>
                    <CardContent>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive a summary of your suggested tasks for the week</p>
                                    </div>
                                    <Switch
                                        id="weekly-digest"
                            ...
                            <div className="space-y-4 pt-6 border-t">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Select value={data.digest_day} onValueChange={(value) => setData('digest_day', value)}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={data.digest_time} onValueChange={(value) => setData('digest_time', value)}>
