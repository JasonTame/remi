...
import {
	getPriorityColor,
	getPriorityLabel,
} from "@/lib/utils/tasks/get-priority-formatting";
			...
			>
				<CardHeader className="pb-2">
					<div className="flex items-start justify-between">
						...
						<span
							className={cn(
								"bg-accent/20 text-accent-foreground rounded-full px-2 py-1 text-xs",
						...
						{isSkipped && (
							<div className="text-orange-600 dark:text-orange-400 text-sm space-y-1">
								<div>
									...
									Skipped:{" "}
									{formatDistanceToNow(new Date(task.skipped_at ?? ""))} ago
								</div>
								{task.skip_reason && (
									<div className="text-orange-500 text-xs pl-4">
