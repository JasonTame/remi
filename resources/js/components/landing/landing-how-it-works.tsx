                ...
                <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="curve1" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="rgb(96, 125, 139)" stopOpacity="0.05" />
                            <stop offset="100%" stopColor="rgb(226, 125, 96)" stopOpacity="0.02" />
                        </linearGradient>
                    </defs>
                    <path d="M0,400 Q300,200 600,300 T1200,250 L1200,0 L0,0 Z" fill="url(#curve1)" />
                </svg>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl mb-4">
                        How <span className="bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent">Remi works</span>
                    </h2>
