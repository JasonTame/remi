    ...
    return (
        ...
        >
            <div className="absolute inset-0 -z-10">
                ...
                <svg className="absolute top-1/3 right-1/4 w-40 h-40 text-primary/5" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fill="currentColor"
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl mb-4">
                        ...
                        <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">remember better</span>
                    </h2>
                    ...
                    {features.map((feature, index) => (
                        <div key={index} className="relative group">
                            ...
                            <Card className="relative h-full shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-white/20 group-hover:scale-105">
                                <CardHeader>
                                    <div className={`mb-4 p-3 bg-gradient-to-br ${feature.gradient} rounded-full w-fit shadow-lg`}>
